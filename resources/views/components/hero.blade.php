      ...
      <div class="col-xxl-5">
        <div class="text-center text-xxl-start">
          <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
            <div class="text-uppercase" id="key_line"></div>
          </div>
          <div class="fs-3 fw-light text-muted" id="short_title">I can help your business to</div>
          <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline" id="title">Get online and grow
              fast</span></h1>
...
async function getHeroData() {
  ...
  try {
    ...
    document.getElementById('key_line').innerHTML = response.data['key_line'];
